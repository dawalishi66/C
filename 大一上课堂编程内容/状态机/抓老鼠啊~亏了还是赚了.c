...
int main(){
    char ch;
    int state=start,price=0;
    while(state!=end){
        ch=getchar();
        switch(state){
            case start:
                if(ch=='X'){state=x;printf("U");}
                else if(ch=='T'){price+=7;printf("D");state=t;}
                else if(ch=='C'){price-=3;printf("!");state=c;}
                else state=end;
                break;
            case x:
                if(ch=='$')state=end;
                else{printf("-");state=happy;}
                break;
            case t:
                if(ch=='$')state=end;
                else{printf("-");state=unhappy;}
                break;
            case c:
                if(ch=='X'){printf("U");state=happy;}
                else if(ch=='T'){price+=7;printf("D");state=happy;}
                else if(ch=='C'){price-=3;printf("!");state=c;}
                else state=end;
                break;
            case happy:
                if(ch=='X'){printf("U");state=x;}
                else if(ch=='T'){price+=7;printf("D");state=t;}
                else if(ch=='C'){price-=3;printf("!");state=c;}
                else state=end;
                break;
